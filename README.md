...
| `js/i18n.js` | All UI strings in 18 languages (EN, HU, DE, NL, ES, PL, SK, RO, SR, SV, DA, NO, IT, PT, CS, HR, EL, TR) |
...
| `js/questions.js` | 100 realistic darts subtraction questions built from language-independent data |
...
- **Calculate** — 100 realistic darts subtractions in random order (opening throws from 501/301 down to the endgame), with instant green/red feedback and a running score.
